...
2. Script akan detect available cameras:
   ...
   - Auto-select jika cuma 1 camera
   - User pilih jika ada multiple cameras
3. Input nama person
4. Press SPACE untuk capture (target: 20+ photos)
5. Gerakkan wajah (kiri, kanan, atas, bawah)
6. Check hasil di `captured_faces/`
