...
**Purpose:** Generate face encodings untuk person
...
# With custom model
manager.generate_encodings('001', model='large')  # More accurate
```

**Parameters:**
- `person_id` (str): Person ID or 'all'
- `model` (str): 'small' or 'large' (default: 'small')

**Returns:** `int` - Number of encodings generated

**Creates:**
- `encodings.pkl` file in person folder
...
- Encoding generation: ~5 photos/second (small model)
