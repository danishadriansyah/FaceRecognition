...
Week 6 Learning Module - Real-time attendance tracking
...
# Import Week 5 recognition service
# Path: lesson-1 -> learning -> minggu-6 -> minggu-5 -> project
week5_path = os.path.join(os.path.dirname(__file__), '..', '..', '..', 'minggu-5-recognition-system', 'project')
sys.path.insert(0, week5_path)

from recognition_service import RecognitionService  # type: ignore
...
class AttendanceSystem:
    ...
    def __init__(self, dataset_path: str = "dataset", log_dir: str = "logs"):
        ...
        self.recognition = RecognitionService(dataset_path=str(dataset_path), tolerance=0.5)
...
if __name__ == "__main__":
    print("Attendance System Module - Week 6 Learning (File-Based)")
    print("="*60)
    
    # Initialize
    system = AttendanceSystem(dataset_path="dataset", log_dir="output")
    ...
    print("   summary = system.get_person_attendance_summary('danis')")
